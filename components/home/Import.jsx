  ...
  return (
    <section className="bg-gray-100 px-8 py-8 rounded-3xl border-[1px] border-primary-100">
      <div className="flex justify-between items-center mb-10">
        ...
        <button className="flex bg-primary-700 px-4 py-2 rounded-md items-start text-white cursor-pointer justify-between w-32 shadow-[0px_6px_14px_-6px_#08235e] ">
        ...
        {features.map((feature, index) => {
          return (
            <div key={index} className="bg-white  rounded-xl p-8 ">
              ...
              <p className="text-sm font text-s_grey-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur, maiores. Fuga repudiandae tenetur rerum rem vitae, officia eligendi doloribus sequi, dolor numquam excepturi.</p>
            </div>
          );
        })}
      </div>
